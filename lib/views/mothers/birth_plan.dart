...
class _BirthPlanScreenState extends State<BirthPlanScreen> {
    ...
    try {
      ...
      if (doc.exists) {
        ...
        setState(() {
          ...
          accompanyingPersonRelationship =
              data['accompanying_person_relationship'] ?? '';
          ...
          _stayUncertain = data['stay_uncertain'] ?? false;
        });
      }
    } catch (e) {
  ...
  List<String> _getMissingFields() {
    ...
    if (selectedFacilityType.isEmpty)
      missing.add(autoI8lnGen.translate("WHERE_WILL_YOU_GIVE_BIRTH"));
    if (selectedTransport.isEmpty)
      missing.add(autoI8lnGen.translate("TRANSPORT_OPTIONS"));
    if (bloodDonorName.isEmpty)
      missing.add(autoI8lnGen.translate("GIVE_BLOOD"));
    if (selectedTimeOption == null)
      missing.add(autoI8lnGen.translate("HOW_LONG_TRIP"));
    if (accompanyingPersonName.isEmpty)
      missing.add(autoI8lnGen.translate("WHO_WILL_COME_W"));
    if (selectedHealthProvider == null)
      missing.add(autoI8lnGen.translate("W_H_P"));
    if (chosenReturnMethod == null) missing.add(autoI8lnGen.translate("W_W_H"));
    if (selectedTransportReturn.isEmpty)
      missing.add(autoI8lnGen.translate("R_HOME"));
    if (caretakerName.isEmpty)
      missing.add(autoI8lnGen.translate("LOOK_CHILDREN"));
  ...
  Widget _buildSummaryItem({
    ...
    final isEmpty =
        value.isEmpty || value == autoI8lnGen.translate("NOT_SPECIFIED");
          ...
          child: Column(
            children: [
              ...
              _buildExpandableSection(
                ...
                children: _isEditMode
                    ? [
                        Row(
                          children: [
                            buildSelectableOption(
                                ...
                                () {
                              setState(() => selectedFacilityType =
                                  autoI8lnGen.translate("HOSPITAL"));
                            },
                                selectedFacilityType ==
                                    autoI8lnGen.translate("HOSPITAL")),
                            buildSelectableOption('HEALTH_CENTER',
                            ...
                            buildSelectableOption(
                                ...
                                () {
                              setState(() => selectedFacilityType =
                                  autoI8lnGen.translate("DISPENSARY"));
                            },
                                selectedFacilityType ==
                                    autoI8lnGen.translate("DISPENSARY")),
                          ],
                        ...
                        if (selectedFacilityType.isNotEmpty) ...[
                          ...
                          TextFormField(
                            ...
                            onChanged: (value) =>
                                setState(() => chosenHealthFacility = value),
                            enabled: _isEditMode,
                          ),
                          SizedBox(height: 12),
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText:
                                  autoI8lnGen.translate("TELEPHONE_NUMBER"),
                              border: OutlineInputBorder(),
                            ),
                    ...
                    : [
                        _buildSummaryItem(
                          label: 'FACILITY_TYPE',
                          value: selectedFacilityType.isEmpty
                        ...
                        if (chosenHealthFacility.isNotEmpty)
                          _buildSummaryItem(
                              label: 'FACILITY_NAME',
                              value: chosenHealthFacility),
                        if (healthFacilityPhoneNumber.isNotEmpty)
                          _buildSummaryItem(
                              label: 'TELEPHONE_NUMBER',
                              value: healthFacilityPhoneNumber),
                      ],
              ),
              ...
              _buildExpandableSection(
                ...
                filledCount: [selectedTransport, selectedTimeOption]
                ...
                children: _isEditMode
                        ...
                        Row(
                          children: [
                            buildSelectableOption(
                                ...
                                () {
                              setState(() => selectedTransport =
                                  autoI8lnGen.translate("FOOT"));
                            },
                                selectedTransport ==
                                    autoI8lnGen.translate("FOOT")),
                            buildSelectableOption(
                    ...
                    : [
                        _buildSummaryItem(
                          ...
                          value: selectedTransport.isEmpty
                              ? autoI8lnGen.translate("NOT_SPECIFIED")
                              : selectedTransport,
                        ),
                        if (selectedTimeOption != null)
              ...
              _buildExpandableSection(
                title: 'GIVE_BLOOD',
                sectionKey: 'blood',
                filledCount: [bloodDonorName, bloodGroup]
                ...
                children: _isEditMode
                    ? [
                          ...
                          children: [
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      autoI8lnGen.translate("RELATIONSHIP"),
                                  border: OutlineInputBorder(),
                                ),
                                onChanged: (value) => setState(
                        ...
                        TextFormField(
                          ...
                          keyboardType: TextInputType.phone,
                          onChanged: (value) =>
                              setState(() => bloodDonorPhoneNumber = value),
                          enabled: _isEditMode,
                        ),
                        SizedBox(height: 12),
                        ...
                        //   decoration: InputDecoration(
                        //     labelText:
                        //         autoI8lnGen.translate("WHAT_BLOOD_GROUP"),
                        //     border: OutlineInputBorder(),
                        //   ),
  ...
  value: bloodGroup.isEmpty ? null : bloodGroup,
  items: ['O', 'A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', autoI8lnGen.translate("DONT_KNOW")]
      .map((String value) {
...
if (bloodGroup == autoI8lnGen.translate("DONT_KNOW")) ...[
  SizedBox(height: 8),
  Container(
    padding: EdgeInsets.all(12),
    decoration: BoxDecoration(
    ...
    child: Row(
      children: [
        ...
        SizedBox(width: 8),
        Expanded(child: AutoText('FIND_OUT_BLOOD_GROUP')),
      ],
    ),
  ),
],
              ...
              _buildExpandableSection(
                ...
                filledCount: [
                  ...
                  willStayAfterBirth?.toString()
                ].where((x) => x != null && x.isNotEmpty).length,
                totalCount: 2,
                children: _isEditMode
                    ? [
                        TextFormField(
                          ...
                          onChanged: (value) => setState(
                              () => accompanyingPersonRelationship = value),
                          enabled: _isEditMode,
                        ),
                        SizedBox(height: 12),
                        TextFormField(
                          ...
                          onChanged: (value) =>
                              setState(() => accompanyingPersonName = value),
                          enabled: _isEditMode,
                        ),
                        SizedBox(height: 12),
                        TextFormField(
                          ...
                          keyboardType: TextInputType.phone,
                          onChanged: (value) =>
                              setState(() => accompanyingPersonPhone = value),
                          enabled: _isEditMode,
                        ),
                        SizedBox(height: 16),
                        AutoText("STAY_AFTER_BIRTH",
  ...
  children: [
    Expanded(
      child: RadioListTile<bool>(
        ...
        onChanged: _isEditMode
            ? (value) => setState(() {
                  willStayAfterBirth = value;
                  _stayUncertain = false;
                })
            : null,
      ),
    ),
...
// "Don't know" as a separate checkbox since RadioListTile only handles bool
CheckboxListTile(
  title: AutoText("DONT_KNOW"),
  value: _stayUncertain,
  onChanged: _isEditMode
      ? (value) => setState(() {
            _stayUncertain = value ?? false;
            if (_stayUncertain) willStayAfterBirth = null;
          })
      : null,
),
if (_stayUncertain) ...[
  ...
  Container(
    ...
    child: Row(
      children: [
        Icon(Icons.favorite_outline, color: Colors.blue[700]),
        SizedBox(width: 8),
        Expanded(child: AutoText('STAY_AFTER_BIRTH_NUDGE')),
      ],
    ),
  ),
],
                    ...
                    : [
                        _buildSummaryItem(
                          ...
                          value: accompanyingPersonName.isEmpty
                              ? autoI8lnGen.translate("NOT_SPECIFIED")
                        ...
                        if (accompanyingPersonPhone.isNotEmpty)
                          _buildSummaryItem(
                              label: 'PHONE', value: accompanyingPersonPhone),
                        if (willStayAfterBirth != null)
                          _buildSummaryItem(
                            label: 'WILL_STAY_AFTER_BIRTH',
                            value: willStayAfterBirth!
                                ? autoI8lnGen.translate("YES_2")
              ...
              _buildExpandableSection(
                title: 'W_H_P',
                sectionKey: 'provider',
                filledCount: [selectedHealthProvider, healthProviderName]
                    .where((x) => x != null && x.toString().isNotEmpty)
                    .length,
                totalCount: 2,
                children: _isEditMode
                    ? [
                        ...
                        if (selectedHealthProvider != null) ...[
                          ...
                          TextFormField(
                            ...
                            onChanged: (value) =>
                                setState(() => healthProviderName = value),
                            enabled: _isEditMode,
                          ),
                          SizedBox(height: 12),
                          TextFormField(
                            ...
                            keyboardType: TextInputType.phone,
                            onChanged: (value) =>
                                setState(() => healthProviderPhone = value),
                            enabled: _isEditMode,
                          ),
                        ],
                      ]
                    : [
                        _buildSummaryItem(
                          ...
                          value: selectedHealthProvider ??
                              autoI8lnGen.translate("NOT_SPECIFIED"),
                        ),
                        if (healthProviderName.isNotEmpty)
                          _buildSummaryItem(
                              label: 'PROVIDER_NAME',
                              value: healthProviderName),
                        if (healthProviderPhone.isNotEmpty)
                          _buildSummaryItem(
                              label: 'PHONE', value: healthProviderPhone),
                      ],
              ),
              ...
              _buildExpandableSection(
                title: 'W_W_H',
                sectionKey: 'return',
                filledCount: [chosenReturnMethod, selectedTransportReturn]
                    .where((x) => x != null && x.toString().isNotEmpty)
                    .length,
                totalCount: 2,
                children: _isEditMode
                    ? [
                        ...
                        if (chosenReturnMethod ==
                            autoI8lnGen.translate("MYSEF")) ...[
                          SizedBox(height: 16),
                        ...
                        Row(
                          children: [
                            buildSelectableOption(
                                'ON_FOOT', Icons.directions_walk, Colors.green,
                                () {
                              setState(() => selectedTransportReturn =
                                  autoI8lnGen.translate("FOOT"));
                            },
                    ...
                    : [
                        _buildSummaryItem(
                          ...
                          value: chosenReturnMethod ??
                              autoI8lnGen.translate("NOT_SPECIFIED"),
                        ),
                        if (taxiName.isNotEmpty)
                          _buildSummaryItem(
                              label: 'TAXI_CONTACT',
                              value: '$taxiName - $taxiPhone'),
                        if (selectedTransportReturn.isNotEmpty)
                          _buildSummaryItem(
                              label: 'RETURN_TRANSPORT',
                              value: selectedTransportReturn),
                      ],
              ),
                ...
                children: _isEditMode
                    ? [
                        TextFormField(
                          ...
                          onChanged: (value) =>
                              setState(() => caretakerRelationship = value),
                          enabled: _isEditMode,
                        ),
                        SizedBox(height: 12),
                        TextFormField(
                        ...
                        TextFormField(
                          ...
                          keyboardType: TextInputType.phone,
                          onChanged: (value) =>
                              setState(() => caretakerPhoneNumber = value),
                          enabled: _isEditMode,
                        ),
                      ]
                    : [
                ...
                children: _isEditMode
                    ? [
                        CheckboxListTile(
                          ...
                          onChanged: _isEditMode
                              ? (value) =>
                                  setState(() => moneyForTransport = value!)
                              : null,
                        ),
                        CheckboxListTile(
                          ...
                          onChanged: _isEditMode
                              ? (value) =>
                                  setState(() => prescribedMedication = value!)
                              : null,
                        ),
                        CheckboxListTile(
                        ...
                        CheckboxListTile(
                          ...
                          value: washBasin,
                          onChanged: _isEditMode
                              ? (value) => setState(() => washBasin = value!)
                              : null,
                        ),
                      ]
                    : [
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              if (moneyForTransport)
                                _buildCheckItem('MONEY_TFARE'),
                              if (prescribedMedication)
                                _buildCheckItem('P_MEDICATION'),
