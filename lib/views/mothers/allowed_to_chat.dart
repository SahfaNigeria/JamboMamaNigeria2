  ...
  void _showNotAvailableDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('Provider Not Available'),
        content: Text(
          'This health provider is not available at the moment.\n\n'
          'Please check their availability schedule or contact them during their working hours. '
          'In case of an emergency, go to the nearest health facility.',
        ),
        actions: [
          TextButton(
            child: Text('OK'),
