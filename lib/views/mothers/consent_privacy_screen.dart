...
class _ConsentScreenState extends State<ConsentScreen>
  ...
  static const String _privacyPolicyUrl =
      'https://smartaccesstohealthforall.org/privacy-policy-safemama-nigeria/'; // ← replace with real URL
            ...
            children: [
              ...
              _InfoSection(
                ...
                bullets: const [
                  'Data is stored securely via Google Firebase, '
                      'which may be outside your own country',
                ],
              ),
              _InfoSection(
                emoji: '⚖️',
              ...
              _ConsentCheckbox(
                ...
                richLabel: const TextSpan(
                  text:
                      'I agree that my data may be stored outside my own country by '
                      'Google Firebase',
                  style: TextStyle(fontSize: 14, color: Color(0xFF333333)),
                ),
              ),
              ...
              Center(
                child: Text(
                  'Compliant with the Global Data Protection Regulation (GDPR) and Nigeria\'s NDPA 2023',
                  style: TextStyle(
                    fontSize: 11,
